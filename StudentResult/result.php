...
html { background: #005B44; cursor: default; }
...
header h1 { background: #4B4453; border-radius: 0.25em; color: #FFF; margin: 0 0 1em; padding: 0.5em 0; }
header address { float: left; font-size: 105%; font-style: normal; line-height: 1.25; margin: 0 1em 1em 0; }
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">QUEZON CITY UNIVERSITY</h2>
                                    <h3 align="center">Novaliches, Quezon City, Metro Manila</h3>  
                                </div>
                            </div>
                            <!-- /.row -->
