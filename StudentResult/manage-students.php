...
<html lang="en">
    <head>
        ...
        <title>SIS Admin Manage Students</title>
...
<tr>
 <td><?php echo htmlentities($cnt);?></td>
                                                            ...
                                                            <td><?php echo htmlentities($result->StudenId);?></td>
                                                            <td><?php echo htmlentities($result->Course & Section );?>(<?php echo htmlentities($result->Section);?>)</td>
