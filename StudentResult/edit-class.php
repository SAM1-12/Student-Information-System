...
<html lang="en">
    <head>
        ...
        <title>SIS Admin Update Class</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Update Student Informartion</h2>
                                </div>
...
{   ?>
                                                    ...
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                            ...
                                                            <span class="help-block">Eg- BSIT,BSENTREP,BS ACCONTANCY etc.</span>
                                                		</div>
                                                	</div>
                                                       <div class="form-group has-success">
                                                        <label for="success" class="control-label">Year Level</label>
                                                        <div class="">
                                                            <input type="number" name="classnamenumeric" value="<?php echo htmlentities($result->ClassNameNumber );?>" required="required" class="form-control" id="success">
                                                            <span class="help-block">Eg- First,Second, Third, Fourth</span>
                                                        </div>
                                                    </div>
                                                     <div class="form-group has-success">
